...
39 apps: lino_startup, staticfiles, about, jinja, bootstrap3, extjs, printing, system, contenttypes, gfks, office, countries, contacts, users, topics, votes, uploads, outbox, xl, excerpts, comments, changes, noi, tickets, faculties, deploy, clocking, lists, blogs, notify, export_excel, tinymce, smtpd, weasyprint, appypod, wkhtmltopdf, dashboard, rest_framework, restful.
48 models:
=========================== ============================ ========= =======
